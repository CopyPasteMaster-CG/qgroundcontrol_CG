...
typedef struct __mavlink_paotou_mavlink_t {
 ...
 uint8_t paotou1; /*<  Test field 6.*/
 uint8_t paotou2; /*<  Test field 7.*/
 uint8_t paotou3; /*<  Test field 8.*/
 uint8_t paotou4; /*<  Test field 9.*/
...
#define MAVLINK_MSG_ID_PAOTOU_MAVLINK_CRC 200
#define MAVLINK_MSG_ID_12_CRC 200
...
#define MAVLINK_MESSAGE_INFO_PAOTOU_MAVLINK { \
    ...
    {  { "enable", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_paotou_mavlink_t, enable) }, \
         ...
         { "paotou1", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_paotou_mavlink_t, paotou1) }, \
         { "paotou2", NULL, MAVLINK_TYPE_UINT8_T, 0, 6, offsetof(mavlink_paotou_mavlink_t, paotou2) }, \
         { "paotou3", NULL, MAVLINK_TYPE_UINT8_T, 0, 7, offsetof(mavlink_paotou_mavlink_t, paotou3) }, \
         { "paotou4", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_paotou_mavlink_t, paotou4) }, \
 ...
 * @param paotou1  Test field 6.
 * @param paotou2  Test field 7.
 * @param paotou3  Test field 8.
 * @param paotou4  Test field 9.
...
static inline uint16_t mavlink_msg_paotou_mavlink_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t enable, uint8_t qian, uint8_t hou, uint8_t zuo, uint8_t you, uint8_t paotou1, uint8_t paotou2, uint8_t paotou3, uint8_t paotou4, uint8_t all)
{
    ...
    _mav_put_uint8_t(buf, 5, paotou1);
    _mav_put_uint8_t(buf, 6, paotou2);
    _mav_put_uint8_t(buf, 7, paotou3);
    _mav_put_uint8_t(buf, 8, paotou4);
    ...
    packet.zuo = zuo;
    packet.you = you;
    packet.paotou1 = paotou1;
    packet.paotou2 = paotou2;
    packet.paotou3 = paotou3;
    packet.paotou4 = paotou4;
    packet.all = all;
...
{
    return mavlink_msg_paotou_mavlink_pack(system_id, component_id, msg, paotou_mavlink->enable, paotou_mavlink->qian, paotou_mavlink->hou, paotou_mavlink->zuo, paotou_mavlink->you, paotou_mavlink->paotou1, paotou_mavlink->paotou2, paotou_mavlink->paotou3, paotou_mavlink->paotou4, paotou_mavlink->all);
}
...
{
    return mavlink_msg_paotou_mavlink_pack_chan(system_id, component_id, chan, msg, paotou_mavlink->enable, paotou_mavlink->qian, paotou_mavlink->hou, paotou_mavlink->zuo, paotou_mavlink->you, paotou_mavlink->paotou1, paotou_mavlink->paotou2, paotou_mavlink->paotou3, paotou_mavlink->paotou4, paotou_mavlink->all);
}
...
{
    return mavlink_msg_paotou_mavlink_pack_status(system_id, component_id, _status, msg,  paotou_mavlink->enable, paotou_mavlink->qian, paotou_mavlink->hou, paotou_mavlink->zuo, paotou_mavlink->you, paotou_mavlink->paotou1, paotou_mavlink->paotou2, paotou_mavlink->paotou3, paotou_mavlink->paotou4, paotou_mavlink->all);
}
...
static inline void mavlink_msg_paotou_mavlink_send(mavlink_channel_t chan, uint8_t enable, uint8_t qian, uint8_t hou, uint8_t zuo, uint8_t you, uint8_t paotou1, uint8_t paotou2, uint8_t paotou3, uint8_t paotou4, uint8_t all)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PAOTOU_MAVLINK_LEN];
    _mav_put_uint8_t(buf, 0, enable);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_paotou_mavlink_send(chan, paotou_mavlink->enable, paotou_mavlink->qian, paotou_mavlink->hou, paotou_mavlink->zuo, paotou_mavlink->you, paotou_mavlink->paotou1, paotou_mavlink->paotou2, paotou_mavlink->paotou3, paotou_mavlink->paotou4, paotou_mavlink->all);
#else
 ...
 */
static inline void mavlink_msg_paotou_mavlink_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t enable, uint8_t qian, uint8_t hou, uint8_t zuo, uint8_t you, uint8_t paotou1, uint8_t paotou2, uint8_t paotou3, uint8_t paotou4, uint8_t all)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field paotou1 from paotou_mavlink message
 *
 * @return  Test field 6.
 */
static inline uint8_t mavlink_msg_paotou_mavlink_get_paotou1(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  5);
}

/**
 * @brief Get field paotou2 from paotou_mavlink message
 *
 * @return  Test field 7.
 */
static inline uint8_t mavlink_msg_paotou_mavlink_get_paotou2(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  6);
}

/**
 * @brief Get field paotou3 from paotou_mavlink message
 *
 * @return  Test field 8.
 */
static inline uint8_t mavlink_msg_paotou_mavlink_get_paotou3(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  7);
}

/**
 * @brief Get field paotou4 from paotou_mavlink message
 *
 * @return  Test field 9.
 */
static inline uint8_t mavlink_msg_paotou_mavlink_get_paotou4(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_paotou_mavlink_decode(const mavlink_message_t* msg, mavlink_paotou_mavlink_t* paotou_mavlink)
{
    ...
    paotou_mavlink->paotou1 = mavlink_msg_paotou_mavlink_get_paotou1(msg);
    paotou_mavlink->paotou2 = mavlink_msg_paotou_mavlink_get_paotou2(msg);
    paotou_mavlink->paotou3 = mavlink_msg_paotou_mavlink_get_paotou3(msg);
    paotou_mavlink->paotou4 = mavlink_msg_paotou_mavlink_get_paotou4(msg);
